      ...
      <div className="App">
        <HelmetProvider>
          ...
          <Routes>
            ...
            <Route path="/single/product/:id" element={<SingleProductSection/>} />
            <Route path="/product/search/:keyword" element={<SearchProductSection/>} />
            <Route path="/product/filter/:price" element={<FilterProductSection/>} />
            <Route path="/product/filter/category/:category" element={<FilterByCategory/>} />
            ...
            <Route path='/reset/password/:token' element={<ResetPasswordSection/>} />
            <Route path="/server/error" element={<InternalServerError/>} />

            {/* Protected Routes */}
            <Route path="/user/profile" element={<ProtectedRoute><UserProfileSection/></ProtectedRoute>} />
            <Route path="/user/change/password" element={<ProtectedRoute><ChangePasswordSection/></ProtectedRoute>} />
            <Route path="/order/shipping" element={<ProtectedRoute><ShippingSection/></ProtectedRoute>} />
            <Route path="/order/confirm" element={<ProtectedRoute><ConfirmOrderSection/></ProtectedRoute>} />
            <Route path="/order/payment" element={<ProtectedRoute><PaymentSection/></ProtectedRoute>} />
            <Route path="/order/payment/success" element={<ProtectedRoute><OrderSuccessSection/></ProtectedRoute>} />
            <Route path="/user/orders" element={<ProtectedRoute><ListofOrdersSection/></ProtectedRoute>} />
            <Route path="/user/single/order/:id" element={<ProtectedRoute><SingleOrderSection/></ProtectedRoute>} />
